...
public class YAxisRenderer extends AxisRenderer {
	...
	public void renderAxisLine(Canvas c) {
		...
		if(mYAxis.isAxisDashedLineEnabled()){
			mAxisLinePaint.setPathEffect(mYAxis.getAxisDashPathEffect());
			Path yAxisPath = new Path();
			
			if (mYAxis.getAxisDependency() == AxisDependency.LEFT) {
				yAxisPath.moveTo(mViewPortHandler.contentLeft(), mViewPortHandler.contentTop());
				yAxisPath.lineTo(mViewPortHandler.contentLeft(),mViewPortHandler.contentBottom());
			} else {
				yAxisPath.moveTo(mViewPortHandler.contentRight(), mViewPortHandler.contentTop());
				yAxisPath.lineTo(mViewPortHandler.contentRight(),mViewPortHandler.contentBottom());
			}
			c.drawPath(yAxisPath, mAxisLinePaint);
		}else{
			if (mYAxis.getAxisDependency() == AxisDependency.LEFT) {
