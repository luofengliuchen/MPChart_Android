...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLine(Canvas c) {
        ...
        if(mXAxis.isAxisDashedLineEnabled()){
        	
        	mAxisLinePaint.setPathEffect(mXAxis.getAxisDashPathEffect());
        	...
        	if (mXAxis.getPosition() == XAxisPosition.TOP
        		...
        		xAxisPath.moveTo(mViewPortHandler.contentLeft(),
                        mViewPortHandler.contentTop());
        		xAxisPath.lineTo(mViewPortHandler.contentRight(),
                        mViewPortHandler.contentTop());
            }
        	...
        	c.drawPath(xAxisPath, mAxisLinePaint);
