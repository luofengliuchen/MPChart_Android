...
public abstract class BarLineChartBase<T extends BarLineScatterCandleData<? extends BarLineScatterCandleDataSet<? extends Entry>>>
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mHighLightIndicatorEnabled && valuesToHighlight())
            mRenderer.drawHighlighted(canvas, mIndicesToHightlight);
        
        drawMarkers(canvas);
        drawSpecialMarkers(canvas);
    ...
    public boolean isHighLightIndicatorEnabled() {
        return mHighLightIndicatorEnabled;
    }

    public void setHighLightIndicatorEnabled(boolean mHighLightIndicatorEnabled) {
        this.mHighLightIndicatorEnabled = mHighLightIndicatorEnabled;
    }
