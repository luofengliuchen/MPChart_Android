...
public class LineDataSet extends LineRadarDataSet<Entry> {
    ...
    private boolean mDrawDoubleColor = false;
    ...
    /** 
     * @description TODO(add color) 
     * @author liuchen 
     * @return
     */ 
     public boolean isDrawDoubleColor() {
         return mDrawDoubleColor;
     }

     public void setDrawDoubleColor(boolean mDrawDoubleColor) {
         this.mDrawDoubleColor = mDrawDoubleColor;
     }
      ...
      * @author liuchen
      */
     private boolean mIsSetLastPointIndicator = false;
     private Bitmap mLastPointIndecator;
     private Bitmap mGreenPoint;
     private Bitmap mRedPoint;
     private String mLastPointIndecatorUnit;
     
     /**
      * @description TODO(add indicator point modify two) 
      * @author liuchen
      * @param mIsSetLastPointIndicator indicator
      */ 
      public void setLastPointIndicator(boolean mIsSetLastPointIndicator,Bitmap mLastPointIndecator){
          this.mIsSetLastPointIndicator = mIsSetLastPointIndicator;
          this.mLastPointIndecator = mLastPointIndecator;
      }
      
      public boolean isSetLastPointIndicator(){
          return mIsSetLastPointIndicator;
      }
      
      public Bitmap getLastPointIndecator(){
          return mLastPointIndecator;
      }

    public Bitmap getGreenPoint() {
        return mGreenPoint;
    }

    public void setLastPointBitmap(Bitmap mGreenPoint,Bitmap mRedPoint) {
    ...
    public String getLastPointIndecatorUnit() {
        return mLastPointIndecatorUnit;
    }

    public void setLastPointIndecatorUnit(String lastPointIndecatorUnit) {
        this.mLastPointIndecatorUnit = lastPointIndecatorUnit;
    }
    
    protected int[] mGradualColors = {0xffffffff , 0XFFFF3B3B};
    
    public void setFillGradualColors(int[] colors){
    	mGradualColors = colors;
    }
    
    public int[] getFillGradualColors(){
    	return mGradualColors;
    }
