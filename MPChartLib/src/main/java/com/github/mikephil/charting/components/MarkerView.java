...
public abstract class MarkerView extends RelativeLayout {
	...
	public abstract void refreshContent(Entry e, Highlight highlight,String xLable);
	
	public abstract void refreshContent(int highlightXIndex ,int highlightDataSetIndex,List<? extends DataSet<? extends Entry>> e);
