...
public abstract class AxisBase extends ComponentBase {
	...
	protected DashPathEffect mAxisDashPathEffect;
    ...
    public void enableAxisDashedLine(float lineLength, float spaceLength, float phase) {
    	mAxisDashPathEffect = new DashPathEffect(new float[] {
                lineLength, spaceLength
        }, phase);
    }
    
    public boolean isAxisDashedLineEnabled() {
        return mAxisDashPathEffect == null ? false : true;
    }
    
    public DashPathEffect getAxisDashPathEffect() {
        return mAxisDashPathEffect;
    }
